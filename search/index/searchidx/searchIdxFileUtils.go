...
import (
	...
	strongsaltcrypto "github.com/overnest/strongsalt-crypto-go"
	"io"
	"io/ioutil"
	"os"
	"sort"
...
func generateTermHmacAndRemoveSearchIndex(sdc client.StrongDocClient, owner SearchIdxOwner, term string, termKey *strongsaltcrypto.StrongSaltKey) error {
	hamcTerm, err := createTermHmac(term, termKey)
	if err != nil {
		return err
	}
	return removeSearchIndex(sdc, owner, hamcTerm)
}
