...
func TestSearchTermIdxSourceTextFileV1(t *testing.T) {
	...
	defer docidx.RemoveDocIndexes(testClient, docID1, docVer1)
	defer docidx.RemoveDocIndexes(testClient, docID1, docVer2)
	...
	//docidx.removeDocIndexes(testClient, docID1, docVer1)
	//docidx.removeDocIndexes(testClient, docID1, docVer2)
	//docidx.removeDocIndexes(testClient, docID2, docVer1)
	//docidx.removeDocIndexes(testClient, docID2, docVer2)
...
func openDocOffsetIndex(t *testing.T, sdc client.StrongDocClient, key *sscrypto.StrongSaltKey, docID string, docVer uint64) docidx.DocOffsetIdx {
