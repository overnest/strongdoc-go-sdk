...
func TestCreateModifiedDoc(t *testing.T) {
	...
	newDoc := testCreateModifiedDoc(t, sdc, oldDoc, key)
	newDoc = testCreateModifiedDoc(t, sdc, newDoc, key)
	newDoc = testCreateModifiedDoc(t, sdc, newDoc, key)
	newDoc = testCreateModifiedDoc(t, sdc, newDoc, key)
}

func testCreateModifiedDoc(t *testing.T, sdc client.StrongDocClient, oldDoc *TestDocumentIdxV1, key *sscrypto.StrongSaltKey) *TestDocumentIdxV1 {
